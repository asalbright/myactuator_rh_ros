"""
@file myactuator_rh_control.launch.py
@brief
...
def generate_launch_description():
    ...
    default_xacro_file = PathJoinSubstitution(
        [
            get_package_share_directory('myactuator_rh_description'),
    ...
    description_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [
                os.path.join(
                    get_package_share_directory('myactuator_rh_description'),
                    'launch', 'myactuator_rh.launch.py'
                )
            ]
        ),
        launch_arguments={
    ...
    controllers = PathJoinSubstitution(
        [
            get_package_share_directory('myactuator_rh_description'),
            'config',
            'myactuator_rh_controllers.yaml',
        ]
    )
    ...
    gazebo_spawner_node = Node(
        ...
        name='gazebo_spawner',
        arguments=['-entity', 'myactuator_rh', '-topic', 'robot_description'],
        output='screen',
        condition=IfCondition(simulation)
    )
