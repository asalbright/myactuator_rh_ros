...
This package contains the **ROS 2 bring-up and configuration files** for the [MyActuator RH-series actuators](https://www.myactuator.com/rmd-xplanetary-motor).
...
```bash
ros2 launch myactuator_rh_bringup myactuator_rh_control.launch.py actuator:=X8ProV2 simulation:=true
```
