/**
 * \file myactuator_rh_hardware_interface.hpp
 * \mainpage
 *    ROS 2 Control hardware interface for MyActuator RH-X series actuators based on CAN
 *    See https://control.ros.org/master/doc/ros2_control/hardware_interface/doc/writing_new_hardware_component.html
 * \author
 *    Tobit Flatscher (github.com/2b-t)
 */

#ifndef MYACTUATOR_RH_HARDWARE__MYACTUATOR_RH_HARDWARE_INTERFACE
#define MYACTUATOR_RH_HARDWARE__MYACTUATOR_RH_HARDWARE_INTERFACE
#pragma once
...
#include <myactuator_rh/driver/can_driver.hpp>
#include <myactuator_rh/actuator_interface.hpp>
...
#include "myactuator_rh_hardware/low_pass_filter.hpp"
#include "myactuator_rh_hardware/visibility_control.hpp"

namespace myactuator_rh_hardware
{

  /**\class MyActuatorRmdHardwareInterface
   * \brief
   *    Hardware interface for the MyActuator RH X-series actuators based on CAN
   */
  ...
  protected:
    ...
    std::unique_ptr<myactuator_rh::CanDriver> driver_;
    std::unique_ptr<myactuator_rh::ActuatorInterface> actuator_interface_;
    myactuator_rh::Feedback feedback_;
...
#endif // MYACTUATOR_RH_HARDWARE__MYACTUATOR_RH_HARDWARE_INTERFACE
