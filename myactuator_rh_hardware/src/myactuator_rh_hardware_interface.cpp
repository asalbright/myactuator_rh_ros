#include "myactuator_rh_hardware/myactuator_rh_hardware_interface.hpp"
...
#include <pthread.h>
#include <sched.h>
#define MYACTUATOR_RH_HARDWARE__THREAD_PRIORITY
#endif
...
#include "myactuator_rh_hardware/conversions.hpp"
...
namespace myactuator_rh_hardware
{
  ...
  CallbackReturn MyActuatorRmdHardwareInterface::on_configure(rclcpp_lifecycle::State const & /*previous_state*/)
  {
    ...
    driver_ = std::make_unique<myactuator_rh::CanDriver>(ifname_);
    actuator_interface_ = std::make_unique<myactuator_rh::ActuatorInterface>(*driver_, actuator_id_);
...
#ifdef MYACTUATOR_RH_HARDWARE__THREAD_PRIORITY
...
#endif // MYACTUATOR_RH_HARDWARE__THREAD_PRIORITY
...
PLUGINLIB_EXPORT_CLASS(myactuator_rh_hardware::MyActuatorRmdHardwareInterface, hardware_interface::ActuatorInterface)
